...
const PaymentForm = () => {
  ...
  return (
    <Box width="50%" mx="auto" p="6" border="0.1px" shadow="md" className='text-teal-700 bg-teal-500/10 rounded-xl space-y-4 p-2'>
      <Box textAlign="center" mb="4">
        <Box as="h2" fontSize="2xl" fontWeight="semibold">Complete Payment to Proceed to Chat</Box>
      </Box>
      <form onSubmit={handleSubmit}>
        ...
        <FormControl mb="4">
          ...
          <CardElement options={{ style: { base: { fontSize: '16px' } } }} className="p-3 border border-teal-300 rounded-md" />
        </FormControl>
        <Button type="submit" disabled={!stripe} colorScheme="teal" size="lg" width="full">
